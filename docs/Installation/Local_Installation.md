...
This is how I develop **BeatLog**. I specify my existing database connection parameters in an `.env` file, instead of environmental variables.
...
- Create and populate a **[.env](#sample-dot-env)** file, model after docker-compose [parameters](/README.md#docker-compose)
